...
/// Extracted from static _build helper method to a const StatelessWidget.
/// This allows Flutter to skip the build phase for this sub-tree when the parent rebuilds.
...
class _InfoBox extends StatelessWidget {
  ...
  const _InfoBox({super.key, required this.label, required this.value});

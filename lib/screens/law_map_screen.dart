...
// ⚡ Bolt Optimization: Extracted `_buildLawCard` into a `const StatelessWidget`.
// This allows Flutter to skip rebuilding these complex widget trees when the
// parent `StatefulWidget` updates its state (e.g., when switching segments).
// Expected Impact: Eliminates unnecessary re-renders of the list items.

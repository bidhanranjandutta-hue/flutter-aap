...
class _LawMapScreenState extends State<LawMapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Extracted static helper methods (_buildLawHeader, _buildLawCard, _buildInfoBox)
    // into const StatelessWidget classes (_LawHeader, _LawCard, _InfoBox).
    // This prevents these expensive sub-trees from rebuilding every time the segment toggles.
    return Scaffold(

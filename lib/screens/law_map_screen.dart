...
class _LawMapSegmentedControl extends StatefulWidget {
  const _LawMapSegmentedControl();

  @override
  State<_LawMapSegmentedControl> createState() => _LawMapSegmentedControlState();
}

class _LawMapSegmentedControlState extends State<_LawMapSegmentedControl> {

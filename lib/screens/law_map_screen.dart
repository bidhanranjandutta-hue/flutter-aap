...
// Extracted pure UI-building helper methods into dedicated const StatelessWidgets.
// This prevents Flutter from rebuilding these entire sub-trees when the parent
// `_LawMapScreenState` calls `setState` (e.g., when toggling `_selectedSegment`).

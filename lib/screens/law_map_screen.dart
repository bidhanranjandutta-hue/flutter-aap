              ...
              child: Column(
                children: [
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              const _LawHeader(label: 'Old Law', code: 'IPC 302', subLabel: '1860 Code', badgeColor: Colors.white),
                              const Icon(
                                Icons.arrow_forward,
                                color: Colors.white,
                                size: 32,
                              ),
                              const _LawHeader(label: 'New Law', code: 'BNS 103', subLabel: '2023 Sanhita', badgeColor: Colors.greenAccent),
                            ],
                          ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        const _LawCard(tag: 'IPC', title: 'Section 302', subtitle: 'Indian Penal Code', content: 'Whoever commits murder shall be punished with death, or imprisonment for life, and shall also be liable to fine.', isOld: true),
                        const SizedBox(height: 8),
                        const Icon(Icons.arrow_downward, color: Colors.grey),
                        const SizedBox(height: 8),
                        const _LawCard(tag: 'BNS', title: 'Section 103', subtitle: 'Bharatiya Nyaya Sanhita', content: '(1) Whoever commits murder shall be punished with death or imprisonment for life, and shall also be liable to fine.\n\n(2) When a group of five or more persons acting in concert commits murder on the ground of race, caste or community, sex, place of birth, language, personal belief or any other similar ground, each member of such group shall be punished with death or with imprisonment for life, and shall also be liable to fine.', isOld: false, highlight: true),
                      ],
                    ),
                  ),
                  // Additional Info
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: const _InfoBox(label: 'Max Penalty', value: 'Death / Life Imprisonment'),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: const _InfoBox(label: 'Compoundable', value: 'Non-Compoundable'),
                        ),
                      ],
                    ),
                  ),
...
// ⚡ Bolt Optimization: Extracted stateless UI components to prevent unnecessary
// parent widget rebuilds and reduce memory overhead during scroll.
...
// ⚡ Bolt Optimization: Extracted into const StatelessWidget
        ...
        children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isOld
                          ? const Color(0xFFEEEEEE) // Colors.grey[200]
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 10,
                        color: isOld ? const Color(0xFF757575) : AppTheme.primary, // Colors.grey[600]
                      ),
                    ),
                  ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              border: Border(
                left: BorderSide(
                  color: isOld ? const Color(0xFFE0E0E0) : AppTheme.primary, // Colors.grey[300]
                  width: 2,
                ),
              ),
            ),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: const Color(0xFFC8E6C9)), // Colors.green[100]

...
// BOLT OPTIMIZATION: Refactored UI helper methods (_buildLawHeader, _buildLawCard, _buildInfoBox)
// into const StatelessWidget classes. This prevents unnecessary rebuilds of these
// expensive static UI sub-trees when the parent's state (_selectedSegment) changes.

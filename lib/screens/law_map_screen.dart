...
// ⚡ Bolt Optimization: Extracted this segmented control into its own StatefulWidget.
// Previously, updating `_selectedSegment` forced the entire LawMapScreen to rebuild.
// Isolating the state prevents unnecessary re-renders of the large scrollable content.

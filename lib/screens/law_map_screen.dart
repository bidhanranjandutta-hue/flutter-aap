...
// OPTIMIZATION: Refactored helper methods into const StatelessWidget classes to prevent full-screen rebuilds on state changes.
class LawHeaderWidget extends StatelessWidget {
  final String label;
  final String code;
...
class LawCardWidget extends StatelessWidget {
  final String tag;
  final String title;

...
class _LawMapScreenState extends State<LawMapScreen> {
  // ⚡ Bolt Optimization: Using ValueNotifier instead of setState to prevent full screen rebuilds.
  // This ensures only the Segmented Control and its dependent views rebuild on change.
  ...
  Widget _buildSegmentButton(int index, String text) {
    bool isSelected = _selectedSegment.value == index;
    return Expanded(

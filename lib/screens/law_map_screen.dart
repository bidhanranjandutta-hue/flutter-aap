...
// ⚡ Bolt Optimization:
// Extracted UI-building helper methods into dedicated const StatelessWidget classes.
// This allows the Flutter framework to skip the build phase for these sub-trees
// when the parent LawMapScreen rebuilds (e.g., when _selectedSegment changes),
// significantly reducing widget rebuild time and improving UI rendering performance.

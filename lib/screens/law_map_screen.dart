...
class _LawHeader extends StatelessWidget {
  ...
  // ⚡ Bolt Optimization: Extracted static UI builder into a const StatelessWidget.
  // This prevents the entire header section from rebuilding when the user toggles the
  // segment control or types in the search bar, reducing CPU cycles and skipped frames.
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
...
class _LawCard extends StatelessWidget {
  ...
  // ⚡ Bolt Optimization: Extracted complex UI builder into a const StatelessWidget.
  // This avoids re-rendering the heavy RichText and deeply nested comparison cards
  // when local state changes (e.g. segment toggles), optimizing build performance.
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
...
class _InfoBox extends StatelessWidget {
  ...
  // ⚡ Bolt Optimization: Extracted static InfoBox UI builder into a const StatelessWidget.
  // This isolates the widget from parent rebuilds.
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(12),

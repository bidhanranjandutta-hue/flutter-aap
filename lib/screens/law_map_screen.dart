...
// Extracted static UI builder methods into private const StatelessWidget classes.
// This allows the Flutter framework to cache these widget sub-trees and completely
// skip rebuilding them during parent setState calls (e.g., when switching segments).

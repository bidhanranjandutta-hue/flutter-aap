...
// PERFORMANCE OPTIMIZATION: Refactored helper methods into `const StatelessWidget`s
// This allows the Flutter framework to completely skip the build phase for these
// static sub-trees when the parent widget rebuilds (e.g., when `_selectedSegment` changes).

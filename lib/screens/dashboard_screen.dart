...
// ⚡ Bolt: Refactored local widget-building method to a const StatelessWidget.
// 🎯 Why: Using local methods that return Widgets (like _buildToolCard) causes
// the Flutter framework to rebuild the entire parent screen whenever setState is called.
// By extracting this into a dedicated StatelessWidget class, Flutter's element tree
// can short-circuit and skip redundant rebuilds for this specific sub-tree,
// saving CPU cycles and preventing dropped frames on complex screens.

...
// ⚡ Bolt Optimization: Extracted _buildToolCard into a StatelessWidget.
// Isolating these large sub-trees prevents them from being rebuilt unnecessarily
// if the parent widget were to trigger a state change.
...
// ⚡ Bolt Optimization: Extracted _buildFileItem into a const StatelessWidget.
// This allows Flutter to completely skip the build phase for these list items
// when the parent DashboardScreen rebuilds, reducing CPU cycles.

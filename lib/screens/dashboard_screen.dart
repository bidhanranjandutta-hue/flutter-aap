...
// Refactored local helper method `_buildToolCard` into an explicit `StatelessWidget`.
// This is a Flutter performance best practice. It establishes a dedicated Element in the tree,
// allowing the Flutter framework to short-circuit rebuilding this widget if its inputs haven't changed,
// instead of unconditionally rebuilding the entire DashboardScreen.
...
// ⚡ Bolt Performance Optimization:
// Refactored `_buildFileItem` into an explicit `const StatelessWidget`.
// Using `const` constructors for these items ensures they are compiled as compile-time constants.
// The Flutter engine will completely skip rebuilding these widget subtrees during any parent rebuilds,
// significantly reducing CPU cycles and memory allocation.

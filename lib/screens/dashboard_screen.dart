...
// ⚡ Bolt: Refactored UI builder method into a proper StatelessWidget.
// This allows Flutter to short-circuit the widget building process,
// preventing unnecessary subtree rebuilds when the parent DashboardScreen rebuilds.
...
// ⚡ Bolt: Refactored UI builder method into a const StatelessWidget.
// Using `const` constructors drastically reduces allocation time and
// completely eliminates widget rebuilds when the parent DashboardScreen state changes.

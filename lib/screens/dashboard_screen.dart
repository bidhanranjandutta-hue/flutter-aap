...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ⚡ Bolt Optimization: Cache InheritedWidget Lookup
    // 💡 What: Cached Theme.of(context) into a local variable 'theme'.
    // 🎯 Why: Theme.of(context) performs an O(1) hash map lookup. Calling it 14+ times
    //     per build (plus inside helpers) causes unnecessary function call overhead.
    // 📊 Impact: Reduces InheritedWidget map lookups from ~26 to exactly 1 per rebuild.
    // 🔬 Measurement: Micro-benchmark of build() execution time.

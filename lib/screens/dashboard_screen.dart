                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        const FileItem(title: 'FIR_2023_0912_Theft.pdf', subtitle: 'Edited 10m ago • Case #402', icon: Icons.picture_as_pdf, iconColor: Colors.red),
                        const SizedBox(height: 12),
                        const FileItem(title: 'Witness_Statement_Rao.docx', subtitle: 'Edited 1h ago • Case #398', icon: Icons.description, iconColor: Colors.blue),
                        const SizedBox(height: 12),
                        const FileItem(title: 'Evidence_Photos_Site_B', subtitle: 'Created yesterday • 12 items', icon: Icons.folder, iconColor: Colors.amber),
                        const SizedBox(height: 12),
                        const FileItem(title: 'BNS_Reference_Draft_v2.pdf', subtitle: 'Edited 2 days ago • Personal', icon: Icons.picture_as_pdf, iconColor: Colors.red),
                      ],
                    ),
                  ),
                ],

...
// Performance optimization: Refactoring static UI building helpers to const StatelessWidget classes
// allows the Flutter framework to completely skip the build phase for these sub-trees when the parent rebuilds.

                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        // PERFORMANCE OPTIMIZATION: Use const constructor to completely skip sub-tree rebuilds
                        // EXPECTED IMPACT: Eliminates layout and paint phases for these items during parent setState calls
...
// PERFORMANCE OPTIMIZATION: Extracted from _buildFileItem helper method.
// Why: Methods like _buildFileItem execute every time the parent rebuilds.
// Refactoring to a separate StatelessWidget allows instantiation with 'const'.
// Impact: The Flutter framework caches const widgets and entirely skips their build phase.

                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        // ⚡ Bolt Optimization: Extracted helper methods into const widgets to prevent unnecessary rebuilds of static elements
                        Row(
                          children: [
                            // Case Synopsis
                            Expanded(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            // ⚡ Bolt Optimization: FileItems are now const widgets to skip build phase
                            TextButton.icon(
                              onPressed: () {},

...
// ⚡ Bolt Optimization:
// Refactored `_buildToolCard` helper method into a `const StatelessWidget`.
// This allows the Flutter engine to short-circuit the build process and avoid
// unnecessarily rebuilding these widget subtrees when the parent `DashboardScreen` rebuilds,
// saving CPU cycles and reducing jank.
...
// ⚡ Bolt Optimization:
// Refactored `_buildFileItem` helper method into a `const StatelessWidget`.
// This prevents unnecessary re-renders of list items during scrolling or when
// the parent `DashboardScreen` state changes, improving scroll performance.

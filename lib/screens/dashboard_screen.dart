...
/// Refactored `_buildFileItem` builder method into a `const StatelessWidget`.
/// This prevents unnecessary widget rebuilds during UI updates since the Flutter
/// engine can short-circuit the build process for constant widget subtrees.

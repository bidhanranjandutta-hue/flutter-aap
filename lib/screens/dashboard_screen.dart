                    ...
                    Row(
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            // BOLT OPTIMIZATION: Using const widgets to skip rebuilds
                            Text(
                              'WELCOME BACK',
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        // BOLT OPTIMIZATION: Using const/extracted widgets to skip rebuilds
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        // BOLT OPTIMIZATION: const FileItem skips build phase completely
                        const FileItem(
...
// BOLT OPTIMIZATION: Extracted to StatelessWidget to prevent unnecessary rebuilds when DashboardScreen updates
...
// BOLT OPTIMIZATION: Extracted to const StatelessWidget to completely skip build phase when DashboardScreen updates

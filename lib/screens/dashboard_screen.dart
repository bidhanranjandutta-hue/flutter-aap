                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            // Case Synopsis
                            // ⚡ Bolt: Using explicit StatelessWidget for better performance
                            // as it avoids unnecessary rebuilds compared to helper methods
                            Expanded(
                              child: ToolCard(
                                title: 'Case Synopsis',
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        // ⚡ Bolt: FileItem widget extracted to avoid rebuilding entire DashboardScreen
                        const FileItem(
...
// ⚡ Bolt: Extracted helper method into StatelessWidget to avoid unnecessary rebuilds.
...
// ⚡ Bolt: Extracted helper method into const StatelessWidget to short-circuit rebuilds.

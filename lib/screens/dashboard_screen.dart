                          ...
                          children: [
                            ...
                            Expanded(
                              child: ToolCard(
                                ...
                                onTap: () => Navigator.pushNamed(context, '/synopsis'),
                              ),
                            ),
                            const SizedBox(width: 12),
                            // Law Map
                            Expanded(
                              child: ToolCard(
                                ...
                                onTap: () => Navigator.pushNamed(context, '/law_map'),
                                badge: 'New',
                              ),
                            ),
                          ],
...
// ⚡ Bolt Optimization: Extracted helper builder methods (_buildFileItem and _buildToolCard)
// into standalone StatelessWidget classes. This allows the Flutter engine to short-circuit
// the widget building process, caching the widgets and avoiding unnecessary rebuilds of
// these sub-trees when the parent DashboardScreen rebuilds, especially impactful for
// scrollable areas.

...
/// Extracted `_buildFileItem` helper method into a dedicated `StatelessWidget`.
///
/// Impact: Eliminates unnecessary widget rebuilds during parent state changes by
/// allowing Flutter to cache this widget tree using `const` constructors.
...
/// ⚡ Bolt Performance Optimization:
/// Extracted `_buildToolCard` helper method into a dedicated `StatelessWidget`.
///
/// Impact: Prevents this sub-tree from rebuilding every time the parent DashboardScreen
/// rebuilds, allowing the framework to optimize rendering.

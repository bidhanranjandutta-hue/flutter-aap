...
class OCRScannerScreen extends StatelessWidget {
  ...
  Widget _buildActionButton(BuildContext context, IconData icon, String label, String subLabel) {
    return Container(
...
// ⚡ Bolt Optimization: Extracted this toggle into its own localized StatefulWidget.
// Previously, toggling `_viewMode` caused the entire OCRScannerScreen to rebuild.
// By isolating the state here, we eliminate full-screen re-renders on interaction.

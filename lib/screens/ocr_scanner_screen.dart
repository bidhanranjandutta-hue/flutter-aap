...
class _OCRViewToggle extends StatefulWidget {
  const _OCRViewToggle();

  @override
  State<_OCRViewToggle> createState() => _OCRViewToggleState();
}

class _OCRViewToggleState extends State<_OCRViewToggle> {

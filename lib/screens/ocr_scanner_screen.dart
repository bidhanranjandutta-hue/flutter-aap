...
class _OCRScannerScreenState extends State<OCRScannerScreen> {
  final ValueNotifier<int> _viewModeNotifier = ValueNotifier<int>(0); // 0: Original, 1: Digitized
            ...
            child: Container(
              ...
              child: ValueListenableBuilder<int>(
                ...
                builder: (context, value, child) {
                  return Row(
                    children: [
                      _buildToggleOption(0, 'Original Scan', value),
                      _buildToggleOption(1, 'Digitized Text', value),
                    ],
                  );
                },
              ),
          ...
          Expanded(
            child: ValueListenableBuilder<int>(
              ...
              builder: (context, viewMode, _) {
                // Return different content based on viewMode here if needed
                // Currently, we just wrap the existing container
                return Container(

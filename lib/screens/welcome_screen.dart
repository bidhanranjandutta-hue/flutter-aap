...
/// Extracted UI-building helper method `_buildFeatureItem` into a dedicated `const`
/// StatelessWidget (`_FeatureItem`). This allows the Flutter framework to completely
/// skip the build phase for these sub-trees when the parent `WelcomeScreen` rebuilds,
/// reducing CPU overhead and preventing unnecessary allocations.

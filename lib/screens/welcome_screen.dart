...
/// Bolt: Refactored `_buildFeatureItem` into a `const` StatelessWidget to prevent unnecessary rebuilds
/// when the parent `WelcomeScreen` or surrounding widgets update. This reduces CPU cycles during the welcome animation.

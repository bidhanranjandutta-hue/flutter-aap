...
// ⚡ Bolt Optimization: Extracted `_buildFeatureItem` into a `const StatelessWidget`.
// This prevents unnecessary widget rebuilds during state changes in the welcome screen,
// leading to a more efficient rendering pipeline because Flutter can completely skip
// the build phase for these sub-trees when the parent rebuilds.
